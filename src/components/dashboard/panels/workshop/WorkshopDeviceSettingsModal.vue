        ...
        <div class="acrylic-modal rounded-xl border border-zinc-200 dark:border-zinc-700 w-full max-w-[430px] p-4" @click.stop>
          <div class="flex items-center justify-between mb-3">
            <div class="min-w-0">
              ...
              <div class="mt-0.5 text-[10px] text-zinc-400 truncate">{{ device.name || device.id }}</div>
            </div>
          ...
          <div v-if="device.reportedAiDescription" class="mt-1 text-[10px] leading-4 text-zinc-400">
          ...
          <div v-if="error" class="mt-2 text-[10px] text-rose-500">
            {{ error }}
          </div>
