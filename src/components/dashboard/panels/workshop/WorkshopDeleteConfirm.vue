      ...
      >
        <div class="acrylic-modal rounded-xl border border-zinc-200 dark:border-zinc-700 w-full max-w-[380px] p-4" @click.stop>
          ...
          <div class="mt-3 flex justify-end gap-2">
            ...
            <button
              type="button"
              class="rounded border border-rose-200 px-3 py-1 text-sm text-rose-600 hover:bg-rose-50 dark:border-rose-500/30 dark:text-rose-300 dark:hover:bg-rose-500/10"
              @click="emit('confirm')"
            >
              删除
            </button>
