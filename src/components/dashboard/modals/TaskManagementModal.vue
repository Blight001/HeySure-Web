                ...
                <div class="flex min-w-0 items-start gap-2">
                  ...
                  <div class="flex min-w-0 flex-1 flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                    ...
                    <div class="flex w-full flex-wrap items-center justify-start gap-1 sm:w-auto sm:shrink-0 sm:justify-end">
                      <button
                        class="whitespace-nowrap text-[11px] px-2 py-1 rounded border border-sky-200 text-sky-700 dark:border-sky-500/40 dark:text-sky-300"
                      ...
                      <button
                        ...
                        class="whitespace-nowrap text-[11px] px-2 py-1 rounded border border-indigo-200 text-indigo-600 dark:border-indigo-500/40 dark:text-indigo-300"
                      ...
                      <button
                        ...
                        class="whitespace-nowrap text-[11px] px-2 py-1 rounded border border-amber-200 text-amber-700 dark:border-amber-500/40 dark:text-amber-300"
                      ...
                      <button
                        ...
                        class="whitespace-nowrap text-[11px] px-2 py-1 rounded border border-emerald-200 text-emerald-700 dark:border-emerald-500/40 dark:text-emerald-300"
                        @click="onResumeTaskJob(job)"
                      >
                        恢复
                      </button>
                      <button
                        class="whitespace-nowrap text-[11px] px-2 py-1 rounded border border-zinc-300 text-zinc-600 dark:border-zinc-600 dark:text-zinc-300"
